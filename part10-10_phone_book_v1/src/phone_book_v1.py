...
class PhoneBookApplication:
    def __init__(self):
        ...
        self.__filehandler = FileHandler("src/phonebook.txt")
...
# def get_key(number: str, book: dict):
...
# my_dict = {"Emilia": ["09-123456"], "Erkki": ["02-123456"]}
# # print(get_key("09-123456", my_dict))

# def print_name(book: dict):
#     number = input("number: ")
#     name = get_key(number, book)
#     if name == None:
#         print("unknown number")
#         return
#     print(name)
